...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'yolov5s-demo.yaml', help='model.yaml path')
    ...
    # YOLOv5-P5 models: yolov5n, yolov5s, yolov5m, yolov5l, yolov5x 设置640
    # YOLOv5-P6 models: yolov5n6, yolov5s6, yolov5m6, yolov5l6, yolov5x6 设置640/1280
    ...
    # v6.2 已支持Apple Silicon MPS support for Apple M1/M2 devices with --device mps
